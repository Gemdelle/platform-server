...
router.post('/1', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 1:', error);
...
router.post('/2', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 2:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/3', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 3:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/4', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 4:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/5', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 5:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/6', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 6:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/7', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 7:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/8', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 8:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/9', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 9:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/10', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 10:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/11', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 11:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/12', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 12:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/13', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 13:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/14', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 14:', error);
        res.status(401).send('Unauthorized');
    }
});
router.post('/15', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 15:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/16', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 16:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/17', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 17:', error);
        res.status(401).send('Unauthorized');
    }
});
...
router.post('/18', async (req, res) => {
    ...
    try {
        ...
        console.error('Error verifying token or validating python course 6 sublevel 18:', error);
        res.status(401).send('Unauthorized');
    }
});
